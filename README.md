...
```
dependencies {
    implementation 'com.roam.sdk:roam-android:0.1.35-beta.2'
}
```
...
[Download](https://github.com/roam-ai/roam-android/releases/download/0.1.35-beta.2/Roam.zip) and unzip Roam SDK
