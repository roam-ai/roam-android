...
```
dependencies {
    implementation 'com.roam.sdk:roam-android:0.1.41-beta.4'
}
```
...
[Download](https://github.com/roam-ai/roam-android/releases/download/0.1.41-beta.4/Roam.zip) and unzip Roam SDK
