...
```
dependencies {
    implementation 'com.roam.sdk:roam-android:0.1.35-beta.1'
}
```
...
[Download](https://github.com/roam-ai/roam-android/releases/download/0.1.35-beta.1/Roam.zip) and unzip Roam SDK
